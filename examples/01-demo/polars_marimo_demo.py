...
@app.cell
def _(EXAMPLES_DIRECTORY, oeplr):
    egfr_df = oeplr.read_smi(EXAMPLES_DIRECTORY / "assets" / "egfr.smi")
...
@app.cell
def _(EXAMPLES_DIRECTORY, oeplr, refmol):
    # Re-read the EGFR DataFrame
    egfr_fpsim_df = oeplr.read_smi(str(EXAMPLES_DIRECTORY / "assets" / "egfr.smi"))
