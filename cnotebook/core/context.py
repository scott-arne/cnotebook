...
# Server-friendly alias. The HTTP layer constructs explicit RenderContext
# instances and never relies on the global cnotebook_context ContextVar.
RenderContext = CNotebookContext
